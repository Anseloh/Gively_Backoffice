        ...
        <b-card>
            <div class="row pt-0">
                ...
                <div class="col-lg-3 col-12 col-md-6">
                    ...
                    <b-input v-model="fundraiserId"></b-input>
                </div>
                <!-- <div class="col-lg-3 col-12 col-md-6">
        ...
        <b-card>
            <b-overlay :show="itemBusy">
                <b-table class="rounded border" :items="items" :fields="fields" :per-page="10" :current-page="1"
                    ...
                    <template #cell(fundraiserTitle)="data">
                        <div style="min-width: 300px">
                            <span class="three-line-ellipsis" v-if="data.item._id">
                                {{data.item.fundraiserTitle}}
                            </span>
            ...
            <b-modal id="confirm-post-transaction" title="Confirmation" cancel-title="No" cancel-variant="primary" ok-variant="danger" @ok="triggerPostTransaction" ok-title="Yes" size="sm" centered no-close-on-backdrop no-close-on-esc>
                <div class="row">
                    <div class="col-12">
                        Are you sure you want to trigger  post transaction process for fundraiser <span class="font-weight-bolder text-primary">{{selectedTransaction.fundraiserTitle}}</span> with transaction number <span class="font-weight-bolder text-dark">{{selectedTransaction.transactionId}}</span>
                    </div>
                </div>
            </b-modal>
                        ...
                        <b-list-group>
                            ...
                            <b-list-group-item>
                                <div class="d-flex">
                                    ...
                                    <div class="w-100 text-dark">
                                        {{selectedTransaction.fundraiserTitle}}
                                    </div>
                                </div>
                            </b-list-group-item>
                            <b-list-group-item>
                            ...
                            <b-list-group-item>
                                <div class="d-flex">
                                    ...
                                    <div class="w-100 text-dark text-uppercase">
                                        {{selectedTransaction.fundraiserId}}
                                    </div>
                                </div>
                            </b-list-group-item>
                            <b-list-group-item>
...
export default {
    ...
    data() {
        return {
            ...
            fields: [
                ...
                { key: 'type', label: 'Type' },
                // { key: 'fundraiserTitle', fundraiserTitle: 'Fundraiser Tittle' },
    ...
    created() {
        ...
        this.fundraiserId = this.$route.query.fundraiserId 
    ...
    methods: {
        ...
        getTransactions(pageNum = 1) {
            // this.pageBusy = true;
            API.getTransactions( {pageNum, ...this.searchParams, transactionType: 1 } ).then(res => {
                this.pageBusy = false;
        ...
        filterTransactions() {
            ...
            if (this.fundraiserId) {
                this.searchParams.serviceId = this.fundraiserId;
            }
